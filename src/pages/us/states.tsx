        ...
        <InfoWindow
          ...
          content={
            <div className="text-justify">
              <p>
                So this is just an easy quiz. It's so easy that I don't even
                want to do any customizable stuffs.
              </p>
              <p>
                Actually this page is the first page I made and it was just to
                help me familiarlize with React lol.
              </p>
            </div>
          }
